...
Many-sorted terms are closely related to mutually recursive algebraic
datatypes without parameters. They generalize terms, which are akin to
singly recursive algebraic datatypes.

To define many-sorted terms, we start with a set of sorts $S$. An
$S$-sorted alphabet consists of a set of symbols and a sorting
