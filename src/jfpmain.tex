...
defines arrows to introduce {\Acon} and eliminate inductive types
...
in the definition of {\Acon} and {\AP}, we find that $G :$~\ATy1, a type with a
...
catamorphism (aka catamorphism operator) at this type:
\ccDataPRF
We omit the details.
...
\ccFunMkvec
\ccDefNatToInd
The encodings of the constructors apply {\Acon} to the left and right
