...
First we define functions that return closed terms, that hat have a similiar semantic as the constructors of the primitive recursion. Than we proove, that they work as expected. 
