...
subsumed by first-order primitive recursive functions on inductive types (PR1-IND). 
A third dimension adds higher-order functions to obtain System-T from
primitive recursion on natural numbers and analogous systems for
words, terms, and many-sorted algebras. At this point, we can subsume
all previous systems in a simply-typed lambda calculus with
inductive types and a primitive recursor.
...
general class. We highlight interesting points like PR1-IND and show
that simply-typed lambda calculus with inductive types is the most
