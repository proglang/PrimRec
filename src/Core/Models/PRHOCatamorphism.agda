...
module Core.Models.PRHOCatamorphism where

open import Level using (Level; suc)
open import Relation.Binary.PropositionalEquality using (_≡_; refl)
open import Core.Types
import Core.PRHOCatamorphism as Syn
import Core.Equations.PRHOCatamorphism as Eq

----------------------------------------------------------------------
-- Raw PR-HO catamorphism-primitive structures over the object-language types
----------------------------------------------------------------------
...
module _ {ℓ} (S : Structure ℓ) where
  ...
  catamorphismArgsᴹ : ∀ {T U} (G : Ty HO 1)
    → (ind G `× U ⇒ᴹ T)
    → ((G [ ind G ]) `× U ⇒ᴹ (G [ T ]) `× U)
...
----------------------------------------------------------------------
-- Law-bearing PR-HO catamorphism-primitive models
----------------------------------------------------------------------
...
module _ {ℓ} (M : Model ℓ) where
  ...
  --------------------------------------------------------------------
  -- Derived distributivity in every PR-HO catamorphism-primitive model
  --------------------------------------------------------------------
