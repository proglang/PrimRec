...
module Core.Translations.ContextualPRFO where

import Relation.Binary.PropositionalEquality as PropEq
open PropEq using (_≡_; refl; cong; cong₂)

import Core.PRFO as PF
import Core.Equations.PRFO as PFEq
import Core.Contextual.PRFO as Ctx
import Core.Contextual.Equations.PRFO as CtxEq
...
compile-sound CtxEq.+-β₂ = PFEq.+-β₂
compile-sound CtxEq.+-η = PFEq.+-η
compile-sound CtxEq.dist-undist = PFEq.dist-undist
compile-sound CtxEq.undist-dist = PFEq.undist-dist
...
reify-sound PFEq.+-β₂ = CtxEq.+-β₂
reify-sound PFEq.+-η = CtxEq.+-η
reify-sound PFEq.dist-undist = CtxEq.dist-undist
reify-sound PFEq.undist-dist = CtxEq.undist-dist
